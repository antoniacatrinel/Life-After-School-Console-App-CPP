...
{
	std::ofstream outFile{ "eventsList.html" };
	if (!outFile.is_open())
...
{
	system("start eventsList.html");
	// or ShellExecuteA(NULL, NULL, "C:\\Program Files(x86)\\Microsoft\\Edge\\Application\\msedge.exe", "eventsList.html", NULL, SW_SHOWMAXIMIZED);
}